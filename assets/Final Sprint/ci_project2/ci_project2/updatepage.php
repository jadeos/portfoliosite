...
<div class="container">
    ...
    <div id ="main">
        ...
        <?php echo form_open("adminfilm/update/$row->id"); ?>
        <?php foreach ($film as $row):?>
        <label>Movie Title  </label><nbsp> <input type ="text" name ="title"><?php echo $row->title ?></input><br/>
                <label>Movie Title  </label><nbsp> <input type ="text" name ="title"value =<?php echo $row->title ?>/><br/>
                            ...
                            <label>Features     </label><nbsp><input type ="text" name ="features"/><br/>
                                <label>Date         </label><nbsp> <input type ="text" name ="date"/><br/>
                                    <label>Time         </label><nbsp> <input type ="text" name ="time"/><br/>
                                        <button type ="submit" name ="submit"value="submit">update </button><br/>
