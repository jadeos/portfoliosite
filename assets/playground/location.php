...
if ($connect->connect_error)
{
   ...
   // $search2=isset($_GET['searchf']);

//create query
$address = isset($_GET['address']);
$address3=$_GET['address'];





$sql = "SELECT * FROM playground where address ='$address3'";
...
//if($row = mysqli_fetch_assoc($result)) {
    ...
    {
//$result=mysqli_query($connect,("SELECT * FROM playground where address = '$address';"));
 ...
 echo  "long ".$long."<br/>" ;
    echo "   lat ". $lat;
        ...
        echo "0 results found for ".$address3;
    }
...
<head>
    ...
    <meta name="description" content="Playground finder app map" />
    <meta name="keywords" content="playground finder app,cork,playground, facility, assessible,homepage,location, app,map,google,search ">
    ...
    <script>
        ...
        var places = [ " <?php echo $address3." cork"?>",];
...
<div class="navbar">
    ...
    <!--canvas-->
    <div id="map_canvas" style="width:65%; height:100%;margin-left:105px;margin-top:-20px;"></div>
    <div id="navigation">-
        <div id="copy" ><span>PlayGround finder</span></div>
