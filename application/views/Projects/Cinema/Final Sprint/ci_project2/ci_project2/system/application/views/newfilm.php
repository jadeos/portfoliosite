        ...
        <div class="container-fluid " style="padding-right: 50px;">
            ...
            <div id="navbar" style="background:transparent !important" class="navbar-collapse collapse">
                <ul class="nav navbar-nav" >
                    ...
                    <li class="active"><a href="filmRecent">Upcoming Events</a></li>
...
<h1><b>New Releases</b></h1>
    ...
    <div id ="twitterfeed" style="width: 270px; height: auto; margin-left:850px;margin-top:0px; border:2px solid black;">
...
<img src ="child44.jpg" alt="child44"id ="user"/>

</div>

    <div class = "mallcop">
        <img src ="mallcop.jpg" alt="mallcop"id ="user"/><br/>
    </div>
    ...
    <div class = "thegooddinosaur">
        <img src ="thegooddinosaur.png" alt="thegooddinosaur"id ="user"/><br/>
    </div>

    <div class = "hobbit">
        <img src ="hobbit.jpg" alt="hobbit"id ="user"/><br/>
    </div>

    <div class = "avengers">
        <img src ="avengers.jpg" alt="avengers"id ="user"/><br/>
    </div>


<div class="descriptionchild44">

<b>An epic thriller not to be missed! <br/>Starring Tom Hardy</b>
</div>
