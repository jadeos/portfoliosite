    ...
    <div id ="accountsmain">
        <div class="mainevent">
            ...
            <div id="details">
                <h3>My Details</h3>
                <b>Name:</b> Shane<br/>
                <b>Email:</b> Shane.corridon@mycit.ie<br/>
                <b>Location:</b> Bishopstown, Co. Cork<br/>

            </div>
            <br/>
            <br/>
            <h3>My Bookings</h3>
            <?php if(isset($bookingm)):foreach($bookingm as $row):?>
               <strong> Booking Number: </strong><?php echo $row->id;?></br/>
                    <strong> Date Added: </strong><?php echo $row->date ;?><br/>
                        <strong>Loyalty Points awarded:</strong><?php echo $row->loyaltypoints;?><br/>
                     <button type = "submit"><?php echo anchor("bookingC/delete/$row->id",'Cancel this booking');?></button><br/>
            ...
            <div id ="news">
                ...
                <b><h3>Most Popular:</h3></b>
                <div id ="charts" style ="width: 100%; height: 400px;margin-left:20px; border:2px solid black;">
                </div>
            </div>
        </div>
        <div id ="rightstuck">
            ...
            <div id="instagramfeed"style="width: 225px; height: auto; margin-left:850px;margin-top:-200px; border:2px solid black;">
                <h4> #cinema on Instagram</h4>
        ...
        <div id = "rated" style="margin-top:50px; margin-left: 400px;">
            <h2>Review Section</h2>
            To delete a review click  here to access the <?php echo anchor('/','homepage');?>


            <h5>Add A review</h5>
            <label>Description  </label><nbsp> <input type ="text" name ="description"></input><br/>
                <button type ="submit" name ="submit" id ="deletebutton" value="submit"><?php echo anchor ("home/add/","Add review");?></button>
